...
export default function Header() {
  ...
  return (
    <div className='bg-white text-black shadow-lg mb-20'>
      <div className='max-w-screen-2xl py-1 px-5 items-center flex justify-between mx-auto'>
        <div className='text-3xl font-bold'> <Link href="/frontend">
          <Image
  ...
  {userEmail !== undefined && userEmail !== null && userWithEmail?.role === "admin" ? (
    <>
  ...
  ${toggle ? `left-0` : `left-[-100%]`}`}>
          {session && userEmail !== undefined && userEmail !== null && userWithEmail?.role === "admin" ? (
            <>
            <li><Link href="/dashboard">Dashboard</Link></li>
             <li><Link href="/frontend">Home</Link></li>
      <li><Link href="/frontend/commentGenerated">Comments</Link></li>
