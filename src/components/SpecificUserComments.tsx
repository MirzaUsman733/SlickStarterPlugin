  ...
  return (
    <div>
      <div className="mx-auto">
        <div className="shadow-2xl shadow-slate-700 max-w-screen-sm lg:max-w-screen-md 2xl:max-w-screen-xl text-black ms-32 p-8 bg-opacity-20 bg-zince-300/10 flex flex-col gap-2 my-6">
          <h1 className="text-2xl text-center font-bold mb-4">All Users Comments</h1>
      ...
      <div className="">
        <div className="min-h-screen container mx-auto ms-28 max-w-screen-sm lg:max-w-screen-md 2xl:max-w-screen-xl flex items-center justify-center">
