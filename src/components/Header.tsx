...
//   return (
//     <div className="bg-white text-black shadow-lg mb-20">
...
//               </li>
//               <li>
//                 <Link href="/frontend/commentGenerated">Comments</Link>
//               </li>
//               <li>
//                 <Link href="/frontend/history">A.History</Link>
//               </li>
//               <li>
//                 <Link href="/frontend/commentsHistory">C.History</Link>
//               </li>
//               {!session ? (
//                 <>
//                   <Link href="/login">
...
//                       signOut();
//                     }}
//                     className="p-2 px-5 -mt-2 bg-blue-800 text-white rounded-full"
//                   >
//                     Logout
//                   </button>
//                 </li>
...
//   const renderLinks = (isAdmin: boolean) => {
...
//         {/* Responsive menu */}
//         <ul
//           className={`duration-500 md:hidden fixed bg-slate-900 top-[84px] h-screen w-full space-y-7 ps-3 text-white pt-5
//             ${toggle ? `left-0` : `left-[-100%]`}`}
//         >
//           {session &&
//           userEmail &&
